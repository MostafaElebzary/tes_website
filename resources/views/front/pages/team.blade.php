    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-3 col-sm-6">
                <div class="single-team-card">
                    <div class="team-image" data-tilt>
                        <img src="{{url('/')}}/assets/images/team/team-1.png" alt="image">
            ...
            <div class="col-lg-3 col-sm-6">
                <div class="single-team-card">
                    <div class="team-image" data-tilt>
                        <img src="{{url('/')}}/assets/images/team/team-2.png" alt="image">
            ...
            <div class="col-lg-3 col-sm-6">
                <div class="single-team-card">
                    <div class="team-image" data-tilt>
                        <img src="{{url('/')}}/assets/images/team/team-3.png" alt="image">
            ...
            <div class="col-lg-3 col-sm-6">
                <div class="single-team-card">
                    <div class="team-image" data-tilt>
                        <img src="{{url('/')}}/assets/images/team/team-4.png" alt="image">
