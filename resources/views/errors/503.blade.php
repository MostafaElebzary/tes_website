...
<head>
    ...
    {{--    <link type="image/x-icon" href="{{settings_image('site_fav')}}">--}}
{{--    <link rel="icon" type="image/png" href="{{url('storage')}}/{{ settings_image("favicon")}}">--}}
    ...
    <style type="text/css">
        ...
        html {
            height: 100%;
            background: #ffffff url({{url('/').'/soon_tes.png'}});
...
{{--        <img id="cspio-logo" src="{{url('/').'/logo.png'}}">--}}
{{--        <h1 id="cspio-headline">كُن على إستعداد</h1>--}}
{{--        <div id="cspio-description">سيتم إطلاق الموقع قريباّ</div>--}}
{{--        <hr>--}}
{{--        <div id="cspio-socialprofiles">--}}
{{--            <a href="https://www.facebook.com/exas2030/" target="_blank"><i--}}
{{--                    class="fa fa-facebook-official fa-2x"></i></a>--}}
{{--            <a href="https://twitter.com/exas2030?s=21&t=HsUW9VweJx7dDjo8dWJBTQ" target="_blank"><i--}}
{{--                    class="fa fa-twitter fa-2x"></i></a>--}}
{{--            <a href="https://www.linkedin.com/company/exas2030/" target="_blank"><i--}}
